...
### 🚨 重要な更新
- **AGTC-501: Phase更新 Phase 2/3 → Phase 3** (重要度: 70/100)

### 🆕 新規プログラム
- Botaretigene

### 🔄 更新されたプログラム
- AGTC-501: Phase 2/3 → Phase 3

### ✅ 変更なし（既知の情報）
- MCO-010, OCU400, NPI-001


### 2026年04月04日（WebSearch全16プログラム検索）
- **WebSearchツールによる全16プログラム最新情報チェック（/update_rp_info full実行）**
...
### ✅ 変更なし（前回3/29の情報と一致）
- MCO-010（BLA rolling submission継続中）
- OCU400（登録完了140名、BLA Q3 2026、トップラインQ1 2027）
- VP-001（FDA Type D meeting完了、登録試験設計中）
- AGTC-501（VISTA登録完了85名、12ヶ月データH2 2026）
- NPI-001（Phase 2/3確認試験計画中）
- SPVN06, SPVN20, Ultevursen, Botaretigene, VG901, ZM-02, DSP-3077, OpCT-001, jCells, Keio_Optogenetics, GS030
