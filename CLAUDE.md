...
6. **Web検索**: gemini-searchコマンドが利用可能な場合は、ビルトインのWebSearchツールではなく、以下のコマンドを使用：
   ```bash
   gemini --prompt "WebSearch: <検索クエリ>"
   ```
   最新の臨床試験情報や論文情報を取得する際に使用
...
- **最速承認予測**: 
  - **MCO-010（Nanoscope社）**: 2025-2026年（2025年6月FDA BLA申請開始、Fast Track指定）
  - **OCU400（Ocugen社）**: 2026-2027年（Phase 3進行中、2026年中頃BLA/MAA申請予定）
  - PYC VP-001: 2028-2029年（2025年後半Phase 2/3開始予定）
  - Beacon AGTC-501: 2028-2029年（Phase 2/3実施中）
- **全体中央値**: 2036年
